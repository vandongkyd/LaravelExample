        ...
        <ul class="nav-left">
            ...
            <li>
                <a href="{{ url("/") }}" target="_blank">
                    Cửu Hàng <i class="fa fa-chevron-right"></i>
                </a>
            </li>
        </ul>
        <ul class="nav-right">
            ...
            <li class="dropdown">
                ...
                <a href="" class="dropdown-toggle no-after peers fxw-nw ai-c lh-1"
                    ...
                    <div class="peer mR-10">
                        <img class="w-2r bdrs-50p" src="{{ empty($user->getAvatar()) ? asset("asset/images/icon_member.png") :  asset("save_image/". $user->getAvatar()) }}" alt=""></div>
                    <div class="peer"><span class="fsz-sm c-grey-900">{{ $user->getFullName() }}</span></div>
                </a>
                <ul class="dropdown-menu fsz-sm">
                    <li>
                        <a href="{{ route("setting.changePassword") }}" class="d-b td-n pY-5 bgcH-grey-100 c-grey-700">
                            <i class="ti-settings mR-10"></i> <span>Đổi Mật Khẩu</span>
                        </a>
                    </li>
                    <li>
                        <a href="{{ route("setting.profile") }}" class="d-b td-n pY-5 bgcH-grey-100 c-grey-700">
                    ...
                    <li>
                        <a href="{{route("admin.logout")}}" onclick="document.getElementById('logout-frm').submit();" class="d-b td-n pY-5 bgcH-grey-100 c-grey-700">
                            <i class="ti-power-off mR-10"></i>
                            <span>Đăng Xuất</span>
                        </a>
                        <form id="logout-frm" action="{{ url('admins/logout') }}" method="POST" style="display: none;">
                            @csrf
                        </form>
                    </li>
                </ul>
